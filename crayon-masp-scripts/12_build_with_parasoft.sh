...
rm -rf $WORK_DIR/ws/build/rclcpp \
  $WORK_DIR/ws/install/rclcpp \
...
cpptesttrace --cpptesttraceProjectName=AdaptiveCore_rclcpp_git_3 --cpptesttraceOutputFile=$PWD/AdaptiveCore_rclcpp_git_3.bdf ./10_build_ks_app_20_and_dependency.sh
