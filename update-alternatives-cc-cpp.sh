...
function register_gcc_version {
    ...
    update-alternatives \
        --install /usr/bin/gcc     cc   /usr/bin/gcc-${version} ${priority} \
        --slave   /usr/bin/gcc-ar           cc-ar          /usr/bin/llvm-ar-${version} \
        --slave   /usr/bin/gcc-nm           llvm-nm          /usr/bin/llvm-nm-${version} \
        --slave   /usr/bin/gcc-ranlib       llvm-ranlib      /usr/bin/llvm-ranlib-${version} \
